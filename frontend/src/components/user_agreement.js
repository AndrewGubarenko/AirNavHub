            ...
            <div className="content">
                <div className="inner_news_container">
                    ...
                    <pre className="news_text">
                        ...
                        <p>
                            Ця угода укладається між Профейсійній спілці «Аеронавігація» (79040, м. Львів, вул. Любінська,
                            217, а/с3983, Львівський РСП Украероруху тел. +38 032 297-21-16) (далі – «Профспілка») - що є власником
                            сайту <a href="http://airnavigation.lviv.ua" style={{color: "#09173f"}}>airnavigation.lviv.ua</a> (далі по тексту - сайт),
                            і приватною особою - відвідують сторінки сайту або використовують хоча б одним із сервісів, що надаються в рамках сайту
                            (далі по тексту - відвідувач сайту). Угода регулює порядок використання ресурсів, сервісів, можливостей сайту,
                            наданої адміністрацією сайту майданчики для отримання інформації.
                        </p>
                        ...
                        <blockquote>2.2.1. Розміщувати повідомлення;</blockquote>
                        <blockquote>2.2.2. Коментувати записи;</blockquote>
                        <blockquote>2.2.3. Використовувати ресурси сайту іншим способом, що не суперечить основам його діяльності.</blockquote>
                        <p>
                        ...
                        <blockquote>
                            3.5.1. Можливість змінювати свої персональні дані, якщо вони недостатньо повні і / або неправильні.
                        </blockquote>
                        <blockquote>
                            3.5.2. Запит на видалення Ваших персональних даних.
                        </blockquote>
                        <blockquote>
                            3.5.3. Якщо Ви вважаєте, що Ваші права та інтереси були порушені, Ви можете пред'явити претензію.
                            Ми зробимо все можливе, щоб виправити ситуацію. Для цієї мети, будь ласка, надішліть нам email на пошту:
                            airnavigation.admin@gmail.com.
                        </blockquote>
                    </pre>
                </div>
            </div>
